...
Template code is provided in the `student_intervention.ipynb` notebook file. To complete your work you will also need to use  `student-data.csv` file which is included. While some code has already been provided to get you started, you will need to implement additional coding to successfully complete the project.
